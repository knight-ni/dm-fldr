...
void myth1(para_t *mypara){
 ...
 ret = fldr_bind_nth(instance, 2, FLDR_C_CHAR, NULL, NULL, data->c2, 100, 100*10, data->c2_len, 0);
 chkerr(ret,instance,1);

 ret = fldr_bind_nth(instance, 3, FLDR_C_CHAR, "YYYY-MM-DD", NULL, data->c3, 100, 100*10, data->c3_len, 0);
 chkerr(ret,instance,1);

 ret = fldr_bind_nth(instance, 4, FLDR_C_CHAR, "YYYY-MM-DD HH:MI:SS.FF6", NULL, data->c4, 100, 100*10, data->c4_len, 0);
 chkerr(ret,instance,1);
 ...
 ret = fldr_bind_nth(instance, 7, FLDR_C_CHAR, NULL, NULL, data->c7, LOBSIZE, LOBSIZE*10, data->c7_len, 0);
 chkerr(ret,instance,1);

 ret = fldr_bind_nth(instance, 8, FLDR_C_BINARY, NULL, NULL, data->c8, LOBSIZE, LOBSIZE*10, data->c8_len, 0);
 chkerr(ret,instance,1);

 ret = fldr_bind_nth(instance, 9, FLDR_C_CHAR, NULL, NULL, data->c9, 100, 100*10, data->c9_len, 0);
 chkerr(ret,instance,1);

 ret = fldr_bind_nth(instance, 10, FLDR_C_BINARY, NULL, NULL, data->c10, LOBSIZE, LOBSIZE*10, data->c10_len, 0);
 chkerr(ret,instance,1);
